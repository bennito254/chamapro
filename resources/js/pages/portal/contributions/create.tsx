...
import MeetingDateSelect, { type MeetingOption } from '@/components/shared/MeetingDateSelect';
import { store } from '@/routes/portal/contributions';
import PageHeader from '@/components/shared/PageHeader';

type Props = {
    members: Array<{ id: number; full_name: string; membership_number: string }>;
...
export default function Page({ members, types, channels, meetings, defaultMeetingId }: Props) {
                        ...
                        {({ errors, processing }) => (
                            <>
                                ...
                                <div className="d-flex gap-2 mt-3">
                                    ...
                                    <Link href="/portal/contributions" className="btn btn-outline-secondary">
                                        Cancel
                                    </Link>
                                </div>
                            </>
