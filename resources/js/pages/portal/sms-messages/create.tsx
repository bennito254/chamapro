...
export default function Page({ templates, members, placeholders }: Props) {
    ...
    const allSelected =
        ...
        selectableMembers.every((member) => selectedIds.includes(member.id));
        ...
        return (
            <>
                ...
                <div className="alert alert-warning">
                    ...
                    <Link href="/portal/sms-templates/create">
                        Create a template
                    </Link>{' '}
                            ...
                            <Form {...route}>
                                {({ errors, processing }) => (
                                    <>
                                        ...
                                        <div className="table-responsive mb-3 rounded border">
                                        ...
                                        <div className="d-flex mt-3 gap-2">
                                            ...
                                            >
                                                {processing
                                                    ? 'Sending...'
                                                    : `Send to ${selectedIds.length} member(s)`}
                                            </button>
                                            <Link
                ...
                <div className="col-lg-4">
                    <div className="card mb-3 border-0 shadow-sm">
                        ...
                        <div className="card-body pt-0">
                            ...
                            <div
                                className="bg-light small rounded border p-3"
                                style={{
                                    minHeight: 120,
                                    whiteSpace: 'pre-wrap',
                                }}
                            >
                                {previewBody ||
                                    'Select a template and member to preview the message.'}
                            </div>
                        </div>
                    </div>
